...
- (void)BlockshowActionSheetInFatherViewController:(UIViewController *)fatherVC {
    _fatherViewController=fatherVC;
    UIActionSheet *sheet = [[UIActionSheet alloc] initWithTitle:nil
                                                       delegate:self
                                              cancelButtonTitle:@"取消"
...
- (void)NSNotificationShowActionSheetInFatherViewController:(UIViewController *)fatherVC {
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info {
    ...
    // 上传用户头像
    if (self.uploadIamgeBlock) {
        self.uploadIamgeBlock(image, OriginalImage);
        self.uploadIamgeBlock=nil;

    }
    
    NSDictionary *dic=@{@"image":image,@"OriginalImage":OriginalImage};
    // 上传用户头像
    [[NSNotificationCenter defaultCenter] postNotificationName:@"CenteruploadImage" object:dic];
